...
| Pontos de acesso | Desktop (só macOS), web, mobile, Workspace, CLI, Code Assist | Claude Desktop unificado (Chat + Cowork + Code), CLI standalone | App Desktop, web, extensão de IDE, CLI |
