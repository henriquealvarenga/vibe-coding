...
A razão da escala envolveu dois acasos felizes que se encontraram na hora certa. Primeiro: eu acabava de terminar meu primeiro aplicativo de iPhone, escrito do zero usando *vibe coding* — descrevendo em português o que queria, deixando a IA escrever o código. Estava recém-publicado na Apple Store, e a experiência tinha sido transformadora. Em poucas semanas, sem ser desenvolvedor profissional, eu tinha um app funcionando, com publicação real numa loja real. Segundo: eu estudo **R desde 2015**, escrevi o *Manual Básico da Linguagem R* [@alvarenga2024manualr] em 2024, e há quase uma década observo de perto como o R poderia ser o padrão de análise de dados nas universidades médicas brasileiras — sem nunca chegar a sê-lo de fato.

A combinação dessas duas coisas — a técnica do vibe coding recém-disponível na minha rotina + uma frustração antiga sobre a barreira de adoção do R em medicina — produziu o argumento que sustenta este curso, e que vale a pena explicitar antes de qualquer outra coisa.

## O argumento

Sempre desejei que o R fosse o padrão de análise de dados nas universidades médicas. As razões eram conhecidas: R é gratuito, aberto, mais poderoso que SPSS ou SAS, com comunidade ativa de bioestatísticos e epidemiologistas. Mas a realidade nas faculdades de medicina foi outra — SPSS continuou dominando, R ficou restrito a nichos. Por quê?

A resposta é prática: **a curva de aprendizado**. Estudantes de medicina têm carga horária massiva, internato extenuante, residência implacável. Aprender uma linguagem de programação, mesmo amigável como R, exige tempo e disposição que jovens médicos pesquisadores raramente têm. Quando o professor de iniciação científica diz "use SPSS", o estudante usa SPSS — e a faculdade paga a licença anual cara. O resultado, na prática, é uma **pulverização** desnecessária. Durante uma trajetória acadêmica de cinco a sete anos, um mesmo estudante passa por três, quatro, cinco *softwares* diferentes — porque cada professor de cada laboratório ensina o seu, e cada IC envolve uma ferramenta nova. O estudante aprende todos superficialmente, não domina nenhum direito, e atrita contra a curva de aprendizado de cada um. Tempo perdido em coisa que poderia ser uma só ferramenta dominada bem.

Os LLMs e a possibilidade de **gerar código a partir de descrição em linguagem natural** mudam essa equação. A barreira da curva de aprendizado não desaparece, mas é rebaixada de "anos de prática" para "semanas de familiaridade". O estudante de medicina hoje pode descrever em português o que quer fazer (*"compare a pressão arterial entre os dois grupos com teste t e gere a tabela formatada para artigo"*) e receber código R funcionando em segundos. Isso destrava a entrada de R e Python como tecnologias acessíveis a quem não é programador profissional — incluindo o pesquisador da área da saúde que tem outras prioridades cognitivas.

As consequências institucionais são sérias e merecem ser ditas em voz alta:

- **Redução de custos.** Universidades não precisam mais arcar com licenças anuais de SPSS, SAS e similares. Para uma instituição com centenas de estudantes e dezenas de pesquisadores, a economia chega a centenas de milhares de reais por ano — recurso que pode ir para outras coisas.
...
- **Reprodutibilidade.** Análises em R e Python são código texto, versionável, auditável, recuperável. Análises em SPSS são cliques perdidos no tempo — irreproduzíveis depois de meses, quanto mais anos.

Vibe coding, R, Python, Quarto, Git, GitHub — todos esses ingredientes existem há algum tempo. **A novidade é a IA tornando-os acessíveis sem o longo aprendizado de programação como pré-requisito**. Isso é o que este curso documenta e propõe.
...
Este curso é **gratuito, aberto, redistribuível**. Todo o material está disponível publicamente em [henriquealvarenga.com](https://henriquealvarenga.com), com fonte versionada no GitHub. Você pode usar para qualquer fim — incluindo como base para suas próprias aulas e materiais didáticos. A coerência entre **defender ciência aberta e praticar ciência aberta** é parte do argumento.
...
Conforme as recomendações do **ICMJE** (*International Committee of Medical Journal Editors*) — e o que o próprio curso ensina no capítulo M1-B1-05 sobre documentar uso de IA em pesquisa — esse uso é declarado **explicitamente aqui no prefácio** em vez de em cada capítulo individual. Modelos utilizados: principalmente **Claude Opus 4.6** e **Claude Sonnet 4.6** (Anthropic), em sessões via Claude Cowork e Claude Code rodando no Positron.
...
Capítulos foram escritos em ritmo intenso, e nem todos passaram por leitura cuidadosa de erro, ambiguidade ou inconsistência. Conteúdo factual foi verificado em fontes primárias sempre que possível (é projeto acadêmico — referências importam), mas erros podem ter passado.
:::
...
- **Issue no GitHub:** *[link do repositório a ser preenchido pelo autor]*
- **Email:** *[endereço de contato a ser preenchido pelo autor]*
...
A todos os **leitores** deste material, presentes e futuros — quem usa, quem critica, quem reporta erros, quem propõe melhorias, quem leva o que aprende para suas próprias salas de aula. O destino deste material está na sua leitura.
